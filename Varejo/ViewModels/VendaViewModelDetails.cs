...
{
    public class VendaViewModelDetails
    {
        ...
        public List<VendaItemViewModelDetails> Itens { get; set; } = new List<VendaItemViewModelDetails>();
    }

    public class VendaItemViewModelDetails
    {
